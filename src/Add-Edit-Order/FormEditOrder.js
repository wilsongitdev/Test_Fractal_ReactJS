...
export default function FormEditOrder(){
    ...
    const [numberOrder, setorderNumber] = useState(0);
    ...
    const btnConfirmAndSave = () => {
        ...
        if (productSelected !== {}){
            ...
            sumPrice += productSelected.unitPriceD * quantity;

            const dataOrderAddProduct = {
                idOrderD: Number(window.location.pathname.split("/")[2]),
                numOrderD: numberOrder,
                dateD: orderSelected.dateD,
                numProductsD: orderSelected.products.length + 1,
            ...
            Promise.all([
                fetch(`${url}/order/update`,{
                    ...
                    body: JSON.stringify(dataOrderAddProduct)
                }).then(res => res.json()),
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={8}>
                <TextField
                    ...
                    type="number"
                    disabled
                    value={orderSelected.numProductsD}
                    InputLabelProps={{
                        shrink: true,
                    }}
                    inputProps={{ min: '0' }}
            ...
            <Grid item xs={8}>
                <TextField
                    ...
                    type="number"
                    disabled
                    value={orderSelected.finalPriceD}
                    InputLabelProps={{
                        shrink: true,
                    }}
                    inputProps={{ min: '0' }}
